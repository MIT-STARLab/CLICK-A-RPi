...
CAMERA_MIN_EXP = 10
#Parameters in offsetParams.csv
NAMES_OFFSET_PARAMS = ['PERIOD_CALCULATE_TX_OFFSETS', 'PERIOD_DITHER_TX_OFFSETS', 'TX_OFFSET_X_DEFAULT', 'TX_OFFSET_Y_DEFAULT', 'TX_OFFSET_SLOPE_X', 'TX_OFFSET_BIAS_X', 'TX_OFFSET_QUADRATIC_Y', 'TX_OFFSET_SLOPE_Y', 'TX_OFFSET_BIAS_Y', 'TX_OFFSET_DITHER_X_RADIUS', 'TX_OFFSET_DITHER_Y_RADIUS', 'DITHER_COUNT_PERIOD']  
