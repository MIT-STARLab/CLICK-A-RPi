...
#define TX_OFFSET_X 0 //pixels, from GSE calibration [old: 20] [new = 2*caliboffset + 20]
#define TX_OFFSET_Y 0 //pixels, from GSE calibration [old: -50] [new = 2*caliboffset - 50]
